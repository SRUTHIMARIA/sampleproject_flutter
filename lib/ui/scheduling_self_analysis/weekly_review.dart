...
import 'package:flutter_template/ui/scheduling_self_analysis/month_review.dart';
...
class WeeklyReview extends StatefulWidget {
  const WeeklyReview({Key? key}) : super(key: key);
              ...
              InkWell(
                onTap: () {
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (context) => MonthReview()));
                },
                child: Center(
                  child: Container(
