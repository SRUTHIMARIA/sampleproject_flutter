...
class ActivationLink extends StatefulWidget {
  const ActivationLink({Key? key}) : super(key: key);

  @override
  State<ActivationLink> createState() => _ActivationLinkState();
}

class _ActivationLinkState extends State<ActivationLink> {
