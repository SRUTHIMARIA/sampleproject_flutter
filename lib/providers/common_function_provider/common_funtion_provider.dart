...
//     await StaticAppPreferences.saveString(key: StaticKeys.tokenLocation, dataToStore: model.token);
//     await StaticAppPreferences.saveString(key: StaticKeys.userNameLocation, dataToStore: model.);
