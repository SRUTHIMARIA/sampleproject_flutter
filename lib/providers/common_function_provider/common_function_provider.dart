...
class CommonFunctionsProvider extends ChangeNotifier {
  ...
  void onAuthenticationSuccess(BuildContext context, LoginSuccessModel model) async {
    await StaticAppPreferences.saveString(key: StaticKeys.tokenLocation, dataToStore: model.data.token);
    // await StaticAppPreferences.saveString(key: StaticKeys.userNameLocation, dataToStore: model.fullName);
    // await StaticAppPreferences.saveInt(key: StaticKeys.quickBloxId, dataToStore: model.quickBloxId);
